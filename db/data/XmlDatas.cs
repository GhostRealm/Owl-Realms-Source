...
namespace db.data
{
  ...
  //          Mods.InitMods(behaviors);
        ...
        public static void ReadXmls()
        {
            ...
            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.elderpcave.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.elderspider.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.elderabyss.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.elderundead.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.eldersprite.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.eldersnake.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.elderocean.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.eldertomb.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.elderjungle.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.elderbeach.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.elderdragon.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.eldermanor.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.elderdavy.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.forgeable.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.newpets.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.phoenixitems.xml");
            ProcessXmlStream(stream);

            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.christmas.xml");
            ProcessXmlStream(stream);
            
            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.candyland.xml");
            ProcessXmlStream(stream);
            
            stream = typeof(XmlDatas).Assembly.GetManifestResourceStream("db.data.Belladonna.xml");
            ProcessXmlStream(stream);
        }
