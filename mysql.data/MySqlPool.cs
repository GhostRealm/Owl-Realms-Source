...
//      var driver = Driver.Create(settings);
    ...
    {
//      var count = Interlocked.Decrement(ref available);
      ...
      try
      {
//        var driver = GetPooledConnection();
    ...
    {
      var fullTimeOut = (int)settings.ConnectionTimeout * 1000;
      var timeOut = fullTimeOut;

      var start = DateTime.Now;

      while (timeOut > 0)
      {
//        var driver = TryToGetDriver();
...
//      var now = DateTime.Now;
      ...
      lock ((idlePool as ICollection).SyncRoot)
      {
        ...
        {
//          var d = idlePool.Peek();
//          var expirationTime = d.IdleSince.Add(
