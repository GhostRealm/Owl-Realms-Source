    ...
    public partial class Form1 : Form
    {
        ...
        public void GetNews()
        {
            try
            {
                ...
                WebRequest request;
                request = WebRequest.Create("https://dl.dropboxusercontent.com/s/txn80tqbpouhfbq/news.xml");//80.241.222.17  http ://80.241.222.17:8889/launcher/getNews
        ...
        private void LoadPlayer()
        {
            ...
            if (File.Exists("client/DoomedRealms.exe") && File.Exists("client/version"))
            {
                if (File.ReadAllText("client/version") == Version)
                {
                    try
                    {
                        ...
                        p.StartInfo.FileName = Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location) + "/client/DoomedRealms.exe";
