...
namespace Empire_World_Launcher
{
    public partial class Updater : Form
    {
        ...
        private void download()
        {
            ...
            wc.DownloadFileAsync(new Uri("https://dl.dropboxusercontent.com/s/dquv04vcgbreahg/Doomed%20Realms.exe"), @"client/Doomed Realms.exe");
        }
        ...
        private void deleteOld()
        {
            ...
            if (System.IO.File.Exists(@"client\Doomed Realms.exe"))
            {
                ...
                try
                {
                    System.IO.File.Delete(@"client\Doomed Realms.exe");
                }
