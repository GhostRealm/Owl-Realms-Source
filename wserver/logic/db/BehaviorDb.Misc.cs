    ...
    partial class BehaviorDb
    {
        private static _ Misc = Behav()
            ...
            .Init(0x2002, Behaves("HeartZ",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 5, 0, 8,
                        ...
                        Tuple.Create(0.05, (ILoot)new ItemLoot("Large Heart Cloth")),
                        Tuple.Create(0.05, (ILoot)new ItemLoot("Small Heart Cloth")),
            ...
            .Init(0x1964, Behaves("Phoenix Wright",
                new RunBehaviors(
                    Chasing.Instance(4, 10, 4, null),
                    CooldownExact.Instance(4000, MultiAttack.Instance(10, 10*(float) Math.PI/180, 5)),
