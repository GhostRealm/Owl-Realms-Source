                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(1, new LootDef(0, 3, 0, 8,
                        Tuple.Create(0.002, (ILoot) new ItemLoot("Seal of Blasphemous Prayer")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Pentaract Eye Generator")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Large Dark Eyes Cloth")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Small Dark Eyes Cloth")),
