                ...
                Behaves("Lord of the Lost Lands",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 2, 0, 2,
                            Tuple.Create(0.05, (ILoot) new ItemLoot("Shield of Ogmur")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Orb of the Chaos Walker")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Knight of the Lost Lands Generator")),
                            ...
                            Tuple.Create(0.9, (ILoot) new StatPotionsLoot(1, 2)) // Tier 1 and 2 potions
                            )))
                    ))
            .Init(0x0d51, Behaves("Protection Crystal",
                new RunBehaviors(
                    StrictCircling.Instance(4f, 0.9f, 0x0d50),
                    Cooldown.Instance(300, MultiAttack.Instance(5, 5*(float) Math.PI/180, 4, projectileIndex: 0))
                    )
                ))
