...
namespace wServer.logic
{
    ...
    {
        static _ ElderForbiddenJungle = Behav()
            .Init(0x7dc3, Behaves("Elder Mixcoatl the Masked God",
            new RunBehaviors(
                ...
                IfEqual.Instance(-1, 1,
                    new RunBehaviors(
                        new QueuedBehavior(
                            ...
                            Cooldown.Instance(200),
                        Cooldown.Instance(200, TossEnemy.Instance(0f, 5f, 0x7dcc)),
                        Cooldown.Instance(400, TossEnemy.Instance(0f, 5f, 0x7dcc)),
                        Cooldown.Instance(600, TossEnemy.Instance(0f, 5f, 0x7dcc)),
                        Cooldown.Instance(800, TossEnemy.Instance(0f, 5f, 0x7dcc))
                        ),
            ...
            .Init(0x7dc2, Behaves("Elder Great Coil Snake",
                    new QueuedBehavior(
                    ...
                    new QueuedBehavior(
                        ...
                        Cooldown.Instance(1000, Rand.Instance(
                            TossEnemy.Instance(0 * (float)Math.PI / 180, 4, 0x7dc1),
                            TossEnemy.Instance(90 * (float)Math.PI / 180, 4, 0x7dc1),
                            TossEnemy.Instance(180 * (float)Math.PI / 180, 4, 0x7dc1),
                            TossEnemy.Instance(270 * (float)Math.PI / 180, 4, 0x7dc1)
                        )),
                        Cooldown.Instance(1000, Rand.Instance(
                            TossEnemy.Instance(0 * (float)Math.PI / 180, 4, 0x7dc1),
                            TossEnemy.Instance(90 * (float)Math.PI / 180, 4, 0x7dc1),
            ...
            .Init(0x7dc1, Behaves("Elder Great Snake Egg",
                    new QueuedBehavior(
                        Cooldown.Instance(5000),
                        new Transmute(0x7dc0, 1, 2)
                    )
                ))
            .Init(0x7dc0, Behaves("Elder Great Temple Snake",
                    ...
                    new QueuedBehavior(
                        ...
                        .Init(0x7dce, Behaves("Elder Basilisk Baby",
                    new RunBehaviors(
                   ...
                   .Init(0x7dcf, Behaves("Elder Basilisk",
                    new RunBehaviors(
                        Cooldown.Instance(1000, MultiAttack.Instance(25, 10 * (float)Math.PI / 180, 4, 0, projectileIndex: 0)),
                        SimpleWandering.Instance(2, 2)
                    ),
                   ...
                   .Init(0x7dd0, Behaves("Elder Mask Shaman",
                    new RunBehaviors(
                        Cooldown.Instance(1000, MultiAttack.Instance(25, 10 * (float)Math.PI / 180, 4, 0, projectileIndex: 0)),
                        SimpleWandering.Instance(2, 2)
                    ),
                   ...
                   .Init(0x7dd1, Behaves("Elder Mask Warrior",
                    new RunBehaviors(
                        Cooldown.Instance(1000, MultiAttack.Instance(25, 10 * (float)Math.PI / 180, 4, 0, projectileIndex: 0)),
                        SimpleWandering.Instance(2, 2)
                    ),
                   ...
                   .Init(0x7dd2, Behaves("Elder Mask Hunter",
                    new RunBehaviors(
                        Cooldown.Instance(1000, MultiAttack.Instance(25, 10 * (float)Math.PI / 180, 4, 0, projectileIndex: 0)),
                        SimpleWandering.Instance(2, 2)
                    ),
                   ...
                   .Init(0x7dcc, Behaves("Elder Totem Spirit",
                    new RunBehaviors(
                        Cooldown.Instance(1000, MultiAttack.Instance(25, 10 * (float)Math.PI / 180, 4, 0, projectileIndex: 0)),
                 ...
                 .Init(0x7dd3, Behaves("Elder Jungle Fire",
                new RunBehaviors(
                    new QueuedBehavior(
