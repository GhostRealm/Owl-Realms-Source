                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 2, 0, 2,
                        ...
                        Tuple.Create(0.1, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Ray Katana")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Black Dragon Gods Blade")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Doku No Ken")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Midnight Star")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Scroll of Zeal")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Magical Powder")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Phoenix Feather")),
                            Tuple.Create(0.03, (ILoot)new ItemLoot("Shattered Amulet")),
                            Tuple.Create(0.02, (ILoot)new ItemLoot("Eternal Elements")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Large Glowthread Cloth")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Small Glowthread Cloth")),
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 2, 0, 2,
                        Tuple.Create(0.05, (ILoot) new ItemLoot("Water Dragon Silk Robe")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Scroll of Zeal")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Blue Dragon Gods Helm")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Magical Powder")),
                        Tuple.Create(0.1, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Phoenix Feather")),
                            Tuple.Create(0.03, (ILoot)new ItemLoot("Shattered Amulet")),
                            Tuple.Create(0.02, (ILoot)new ItemLoot("Eternal Elements")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Large Cloud Cloth")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Small Cloud Cloth")),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Def)),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Vit)),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Wis)),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Dex)),
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 2, 0, 2,
                        Tuple.Create(0.05, (ILoot) new ItemLoot("Fire Dragon Battle Armor")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Scroll of Zeal")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Red Dragon Gods Helm")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Magical Powder")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Phoenix Feather")),
                        Tuple.Create(0.1, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.03, (ILoot)new ItemLoot("Shattered Amulet")),
                            Tuple.Create(0.02, (ILoot)new ItemLoot("Eternal Elements")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Large Pink Sparkly Cloth")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Small Pink Sparkly Cloth")),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Def)),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Vit)),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Wis)),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Dex)),
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 2, 0, 2,
                        Tuple.Create(0.05, (ILoot) new ItemLoot("Leaf Dragon Hide Armor")),
                            Tuple.Create(0.06, (ILoot)new ItemLoot("Leaf Bow")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Green Dragon Gods Helm")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Scroll of Zeal")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Magical Powder")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Phoenix Feather")),
                        Tuple.Create(0.1, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.03, (ILoot)new ItemLoot("Shattered Amulet")),
                            Tuple.Create(0.02, (ILoot)new ItemLoot("Eternal Elements")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Large Vine Cloth")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Small Vine Cloth")),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Def)),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Vit)),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Wis)),
                        Tuple.Create(0.5, (ILoot) new StatPotionLoot(StatPotion.Dex)),
