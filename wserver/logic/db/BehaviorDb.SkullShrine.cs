                ...
                IfNot.Instance(
                    ...
                    Cooldown.Instance(5000,
                        ...
                        Tuple.Create(100, new LootDef(0, 3, 0, 8,
                            ...
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Skull Shrine Generator")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Large Skull Cloth")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Small Skull Cloth")),
