            ...
            .Init(0x1706, Behaves("Thessal the Mermaid Goddess",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 5, 2, 5,
                        ...
                        Tuple.Create(0.004, (ILoot)new ItemLoot("Coral Medallion")),
                        ...
                        Tuple.Create(0.01, (ILoot) new ItemLoot("Coral Venom Trap")),
                            ...
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Sea Horse Generator")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Sea Mare Generator"))
                        )))
                ))
