    ...
    partial class BehaviorDb
    {
        private static readonly LootDef CommonLesserGodSoulBag =
            new LootDef(0, 2, 0, 8,
                ...
                Tuple.Create(0.01, (ILoot)new ItemLoot("Minotaur Generator")),
                Tuple.Create(0.008, (ILoot)new ItemLoot("Large Brown Stitch Cloth")),
                Tuple.Create(0.008, (ILoot)new ItemLoot("Small Brown Stitch Cloth")),
                Tuple.Create(0.008, (ILoot)new ItemLoot("Large Crossbox Cloth")),
                Tuple.Create(0.008, (ILoot)new ItemLoot("Small Crossbox Cloth")),
        ...
        private static _ Highland = Behav()
            ...
            .Init(0x0957, Behaves("Urgle",
                ...
                .Init(0x7527, Behaves("Dallas Bug",
                new RunBehaviors(
        ...
        .Init(0x7528, Behaves("Luci Hellhound",
                 new RunBehaviors(
                    SimpleWandering.Instance(5, 10),
                   Cooldown.Instance(1000, SimpleAttack.Instance(7, 0))
                   ),
                ...
                .Init(0x7529, Behaves("Lunar Deer",
                 new RunBehaviors(
                    SimpleWandering.Instance(5, 10),
                   Cooldown.Instance(1000, SimpleAttack.Instance(7, 0))
                   ),
