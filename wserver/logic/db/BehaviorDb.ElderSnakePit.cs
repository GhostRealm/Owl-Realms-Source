...
namespace wServer.logic
{
    ...
    {
        private static _ ElderSnakePit = Behav()
            .Init(0x5917, Behaves("Elder Stheno the Snake Queen",
                new RunBehaviors(
                    If.Instance(EntityLesserThan.Instance(20, 4, 0x5918),
                        Cooldown.Instance(500, SpawnMinionImmediate.Instance(0x5918, 1, 1, 1))),
                    ...
                    IfEqual.Instance(-1, 2,
                        new RunBehaviors(
                            If.Instance(EntityLesserThan.Instance(10, 8, 0x5919),
                                Cooldown.Instance(100, SpawnMinionImmediate.Instance(0x5919, 3, 1, 1))),
                            ...
                            new QueuedBehavior(
                                ...
                                OrderAllEntity.Instance(20, 0x5919, Despawn.Instance),
                                new SetKey(-1, 3)
                                ))),
                    IfEqual.Instance(-1, 3,
                        new RunBehaviors(
                            Cooldown.Instance(500, RingAttack.Instance(8, 4, 0, 1)),
                            Cooldown.Instance(1000, ThrowAttack.Instance(5, 8, 100)),
                            new QueuedBehavior(
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 2, 2, 8,
                        Tuple.Create(1.0, (ILoot)new ItemLoot("Potion of Max Speed")),
                        ...
                        new DeathPortal(0x6838, 100, 100)
                    }
                ))
            .Init(0x5e26, Behaves("Elder Snakepit Guard",
            ...
            .Init(0x5918, Behaves("Elder Stheno Pet",
                IfNot.Instance(
                    Circling.Instance(14, 20, 18, 0x5917),
                    SimpleWandering.Instance(4)
                    ),
                Chasing.Instance(8, 3, 3, null),
                Cooldown.Instance(2000, SimpleAttack.Instance(20, projectileIndex: 0))
                ))
            .Init(0x5919, Behaves("Elder Stheno Swarm",
                IfNot.Instance(
                    Chasing.Instance(4, 100, 2, 0x5917),
                    SimpleWandering.Instance(4)
                    ),
                If.Instance(IsEntityNotPresent.Instance(10, 0x5917), Despawn.Instance),
                Cooldown.Instance(1000, SimpleAttack.Instance(20, projectileIndex: 0))
                ))
            .Init(0x5223, Behaves("Elder Pit Snake",
                SimpleWandering.Instance(8),
                Cooldown.Instance(1000, SimpleAttack.Instance(10, projectileIndex: 0))
                ))
            .Init(0x5224, Behaves("Elder Pit Viper",
                SimpleWandering.Instance(9),
                Cooldown.Instance(1000, SimpleAttack.Instance(10, projectileIndex: 0))
                ))
            .Init(0x5227, Behaves("Elder Yellow Python",
                IfNot.Instance(
            ...
            .Init(0x5226, Behaves("Elder Brown Python",
            ...
            .Init(0x5225, Behaves("Elder Fire Python",
                IfNot.Instance(
            ...
            .Init(0x5228, Behaves("Elder Greater Pit Snake",
                IfNot.Instance(
            ...
            .Init(0x5229, Behaves("Elder Greater Pit Viper",
                IfNot.Instance(
                    Chasing.Instance(10, 10, 5, null),
                    SimpleWandering.Instance(8)
                    ),
