    ...
    partial class BehaviorDb
    {
        private static _ Oryx = Behav()
            .Init(0x0932, Behaves("Oryx the Mad God 2",
                new RunBehaviors(
                    new State("idle",
                        ...
                        Cooldown.Instance(1000, MultiAttack.Instance(25, 10*(float) Math.PI/180, 3, 0, 2)),
                        Cooldown.Instance(1000, MultiAttack.Instance(25, 10*(float) Math.PI/180, 2, 0, 3)),
                        Cooldown.Instance(1000, MultiAttack.Instance(25, 10*(float) Math.PI/180, 3, 0, 4)),
                    ...
                    new State("idle",
                        HpGreaterEqual.Instance(15000,
                            new RunBehaviors(
                                ...
                                If.Instance(EntityLesserThan.Instance(6, 3, 0x0944),
                ...
                new RunBehaviors(
                    new State("dance",
                        ...
                        Tuple.Create(100, new LootDef(2, 5, 1, 15,
                            ...
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Potion of Oryx")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Seal of Blasphemous Prayer")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Amulet of the Undying Army")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Amulet of Mother Nature")),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Shattered Rune of Oryx")),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Broken Oryx Armor")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Large Chainmail Cloth")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Small Chainmail Cloth")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Purified Doom Saliva")),
                            Tuple.Create(0.02, (ILoot)new ItemLoot("White Bag Generator")),
                    ...
                    condBehaviors: new ConditionalBehavior[] {
                        ...
                        new DeathPortal(0x1901, 100, 100)
                    }
                ))
            ...
            .Init(0x2001, Behaves("Oryx the Mad God 3",
                new RunBehaviors(
                    ...
                    new State("battle",
                        ...
                        If.Instance(CheckConditionEffects.Instance(new[] {ConditionEffects.Stunned}),
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(2, 5, 2, 20,
                ...
                //            Tuple.Create(0.0001, (ILoot)new ItemLoot("The Staff Of Miley")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Shattered Rune of Oryx")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Broken Oryx Armor")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Oryx Scroll")),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Large Twilight Cloth")),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Small Twilight Cloth")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Large Starry Cloth")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Small Starry Cloth")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Purified Doom Saliva")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Tome of Noble Assault")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Potion of Oryx"))
                        ))),
                condBehaviors: new ConditionalBehavior[]
                {
                    new OnDeath(new SimpleTaunt("I'm such a weakling...")),
                                        new DeathPortal(0x3721, 100, 100)
                }
                ))
            ...
            .Init(0x2003, Behaves("Knight of the Void",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 1, 0, 8,
                        Tuple.Create(0.0001, (ILoot) new ItemLoot("Sword of Dark Enchantment"))
            ...
            .Init(0x1740, Behaves("Oryx the Mad God 1",
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 1,
                        new RunBehaviors(
                            Once.Instance(SpawnMinionImmediate.Instance(0x1749, 4, 4, 6)),
                            Cooldown.Instance(1000,
                                If.Instance(EntityLesserThan.Instance(20, 4, 0x1749),
                                    SpawnMinionImmediate.Instance(0x1749, 4, 1, 1))),
                            Cooldown.Instance(800, MultiAttack.Instance(10, 15*(float) Math.PI/180, 4, 0, 4)),
                            new QueuedBehavior(
                                Cooldown.Instance(20000),
                                OrderAllEntity.Instance(20, 0x1749, Despawn.Instance),
                                new SetKey(-1, 3)
                                )
                            )
                        ),
                    ...
                    IfEqual.Instance(-1, 3,
                        new RunBehaviors(
                            ...
                            new QueuedBehavior(
                                new RunBehaviors(
                                    TossEnemy.Instance(24*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(48*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(72*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(96*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(120*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(144*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(168*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(192*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(216*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(240*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(264*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(288*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(312*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(336*(float) Math.PI/180, 9, 0x1748),
                                    TossEnemy.Instance(360*(float) Math.PI/180, 9, 0x1748)),
                                Cooldown.Instance(50000)
                                ),
                            Cooldown.Instance(900, RingAttack.Instance(15, 20, 0, 6)),
                            Cooldown.Instance(3000, ThrowAttack.Instance(4, 5, 240)),
                            Cooldown.Instance(3000, ThrowAttack.Instance(4, 5, 240, 160)),
                            Cooldown.Instance(3000, ThrowAttack.Instance(4, 5, 240, 180)),
                            new QueuedBehavior(
                                Cooldown.Instance(30000),
                                OrderAllEntity.Instance(20, 0x1748, Despawn.Instance),
                                new SetKey(-1, 3)))
                        )
                    ),
                IfEqual.Instance(-1, 4,
                    new RunBehaviors(
                        ...
                        Timed.Instance(2500, Flashing.Instance(200, 0xf389E13)),
                        Cooldown.Instance(1500, RingAttack.Instance(3, 10, 0, 9)),
                        Cooldown.Instance(2000, RingAttack.Instance(10, 10, 0, 8)),
                        Cooldown.Instance(500, RingAttack.Instance(10, 10, 0, 7)),
                        //Inner Elements
                        Once.Instance(
                            new RunBehaviors(
                ...
                IfEqual.Instance(-1, 4,
                    new RunBehaviors(
                        ...
                        Timed.Instance(2500, Flashing.Instance(200, 0xf389E13)),
                        Timed.Instance(7000, Cooldown.Instance(2000, RingAttack.Instance(10, 20, 0, 16))),
                        Cooldown.Instance(900, RingAttack.Instance(15, 20, 0, 6)),
                        ...
                        //    Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3, offset: 342 * (float)Math.PI / 180, projectileIndex: 0)))
                            ...
                            Tuple.Create(100, new LootDef(1, 2, 1, 2,
                                ...
                                Tuple.Create(0.07, (ILoot) new TierLoot(3, ItemType.Ring)),
                    ...
                    new ChatEvent(new SimpleTaunt("NEVER"))
                    .SetChats(new string[]{ "Die", "die", "die allready", "die already", "Die allready!", "Die!", "die!", "die already!" })
                }

                ))
            .Init(0x1960, Behaves("Oryx the Mad God 4",
                new RunBehaviors(
                    If.Instance(IsEntityPresent.Instance(10, null),
                        Once.Instance(new SetKey(-1, 1))),
                    Once.Instance(new SimpleTaunt("Fools! I still have {HP} hitpoints!")),
                        ...
                        new RunBehaviors(
                            ...
                            new QueuedBehavior(
                                new RunBehaviors(
                                    ...
                                    CooldownExact.Instance(3000, SpawnMinionImmediate.Instance(0x2013, 5, 1, 1))
                        ),
                        If.Instance(CheckConditionEffects.Instance(new ConditionEffects[] { ConditionEffects.Stunned }),
                                    CooldownExact.Instance(3000, SpawnMinionImmediate.Instance(0x2013, 5, 1, 1))
                        ),
            ...
            //    Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3, offset: 342 * (float)Math.PI / 180, projectileIndex: 0)))
                            ...
                            Tuple.Create(100, new LootDef(5, 6, 5, 22,
                           Tuple.Create(0.05, (ILoot)new ItemLoot("Doom Bow")),
                            Tuple.Create(0.029, (ILoot)new TierLoot(8, ItemType.Ability)),
                            Tuple.Create(0.029, (ILoot)new TierLoot(15, ItemType.Armor)),
                            Tuple.Create(0.029, (ILoot)new TierLoot(14, ItemType.Weapon)),
                            Tuple.Create(0.00009, (ILoot)new ItemLoot("Crown")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Oryx Tooth Sword")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Tornado Generator")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Rain Bow")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Gyarados Generator")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Doom Dirk")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Platinum Wand")),
                            Tuple.Create(0.5, (ILoot)new ItemLoot("Platinum Sword")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Large Black Striped Cloth")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Small Black Striped Cloth")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Oryx Hide Robe")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Oryx Hide Armor")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Oryx Scale Armor")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Ring of Oryx")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Doom Poison")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Shark Generator")),
                            Tuple.Create(0.5, (ILoot)new ItemLoot("Potion of Oryx")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("XP Booster")),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Strike Amulet")),
                            Tuple.Create(0.4, (ILoot)new ItemLoot("Transformation Potion")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Flying Doom Daggers")),
                            Tuple.Create(0.6, (ILoot)new ItemLoot("Shattered Rune of Oryx")),
                            Tuple.Create(0.5, (ILoot)new ItemLoot("Broken Oryx Armor")),
                            Tuple.Create(0.4, (ILoot)new ItemLoot("Large Oryx Cloth")),
                            Tuple.Create(0.4, (ILoot)new ItemLoot("Small Oryx Cloth")),
                            Tuple.Create(0.4, (ILoot)new ItemLoot("Purified Doom Saliva"))
                                ))),
                                                condBehaviors: new ConditionalBehavior[] {
                    new DeathPortal(0x2928, 100, 100),
                    new ChatEvent(new SimpleTaunt("NEVER"))
                    .SetChats(new string[]{ "Die", "die", "die allready", "die already", "Die allready!", "Die!", "die!", "die already!" })
                }
                ))
            ...
            .Init(0x174e, Behaves("Outer Guardian Element",
                new RunBehaviors(
                    ...
                    .Init(0x2012, Behaves("Oryx the Mad God 5",
                new RunBehaviors(
                    new State("idle",
                        SetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                        IfNot.Instance(
                            IsEntityPresent.Instance(20000, 0x2014),
                            SetState.Instance("flash")
                        )
                    ),
                    new State("flash",
                        SetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                        Once.Instance(new RunBehaviors(new SimpleTaunt("How DARE you follow me here, this will be your DOOM."))),
                        Timed.Instance(24000, False.Instance(Flashing.Instance(250, 0xffff0000))),
                        CooldownExact.Instance(5000, Once.Instance(new SimpleTaunt("You have killed me too many times."))),
                        CooldownExact.Instance(10000, Once.Instance(new SimpleTaunt("This is MY realm."))),
                        CooldownExact.Instance(15000, Once.Instance(new SimpleTaunt("Now, I will rip your soul from my realm."))),
                        CooldownExact.Instance(20000, Once.Instance(new SimpleTaunt("This day will be MINE!"))),
                        CooldownExact.Instance(22000, Once.Instance(new SimpleTaunt("Prepare to meet your DOOM!"))),
                        CooldownExact.Instance(24000, UnsetConditionEffect.Instance(ConditionEffectIndex.Invulnerable)),
                        CooldownExact.Instance(24000, SetState.Instance("battle")),
                        new QueuedBehavior(
                            PlaySound.Instance(1),
                    ...
                    new State("battle",
                        ...
                        Cooldown.Instance(5000, RingAttack.Instance(16, projectileIndex: 9)),
                        If.Instance(CheckConditionEffects.Instance(new ConditionEffects[] { ConditionEffects.Stunned }),
                                    CooldownExact.Instance(1000, SpawnMinionImmediate.Instance(0x2013, 5, 1, 1))
                        ),
                        HpLesserPercent.Instance(0.1f, SetState.Instance("neardeath"))
                    ),
                    new State("neardeath",
                        Once.Instance(new SimpleTaunt("I will destroy you!")),
                                Chasing.Instance(3, 25, 2, null),
                        Cooldown.Instance(800, MultiAttack.Instance(25, 50 * (float)Math.PI / 180, 3, 0, projectileIndex: 1)),
                        Cooldown.Instance(800, MultiAttack.Instance(25, 50 * (float)Math.PI / 180, 3, 0, projectileIndex: 2)),
                        Cooldown.Instance(800, MultiAttack.Instance(25, 50 * (float)Math.PI / 180, 2, 0, projectileIndex: 3)),
                        Cooldown.Instance(800, MultiAttack.Instance(25, 50 * (float)Math.PI / 180, 3, 0, projectileIndex: 4)),
                        Cooldown.Instance(800, MultiAttack.Instance(25, 50 * (float)Math.PI / 180, 3, 0, projectileIndex: 9)),
                        Cooldown.Instance(800, MultiAttack.Instance(25, 50 * (float)Math.PI / 180, 2, 0, projectileIndex: 5)),
                        Cooldown.Instance(800, MultiAttack.Instance(25, 50 * (float)Math.PI / 180, 3, 0, projectileIndex: 6)),
                        If.Instance(CheckConditionEffects.Instance(new ConditionEffects[] { ConditionEffects.Stunned }),
                                    CooldownExact.Instance(1000, SpawnMinionImmediate.Instance(0x2013, 5, 1, 1))
                        ),
                        If.Instance(CheckConditionEffects.Instance(new ConditionEffects[] { ConditionEffects.Stunned }),
                                    CooldownExact.Instance(2000, SpawnMinionImmediate.Instance(0x2013, 5, 1, 1))
                        ),
                        If.Instance(CheckConditionEffects.Instance(new ConditionEffects[] { ConditionEffects.Stunned }),
                                    CooldownExact.Instance(3000, SpawnMinionImmediate.Instance(0x2013, 5, 1, 1))
                        ),
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(5, 9, 6, 25,
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Doom Bow")),
                            Tuple.Create(0.2, (ILoot)new TierLoot(8, ItemType.Ability)),
                            Tuple.Create(0.2, (ILoot)new TierLoot(9, ItemType.Ability)),
                            ...
                            Tuple.Create(0.09, (ILoot)new ItemLoot("Potion of Power")),
            ...
            //                            Tuple.Create(0.1, (ILoot)new ItemLoot("Helm of the Pumpkin")),
                ...
                condBehaviors: new ConditionalBehavior[] {
                    new OnDeath(new SimpleTaunt("How can this BE!!!")),
                    new DeathPortal(0x6717, 100, 100),
                    new ChatEvent(new SimpleTaunt("NEVER"))
                    .SetChats(new string[]{ "Die", "die", "die allready", "die already", "Die allready!", "Die!", "die!", "die already!" })
                }
            ))
            .Init(0x2014, Behaves("Tree of Doom",
                condBehaviors: new ConditionalBehavior[] {
                    new OnDeath(
                        If.Instance(
                            IsEntityPresent.Instance(20000, 0x2014),
                            Rand.Instance(
                                new SimpleTaunt("We protect the lord!"),
                                new SimpleTaunt("You will die today!"),
                                new SimpleTaunt("Prepare to meet your DOOM!")
                            )
                        )
                    )
                }
            ))
            .Init(0x2013, Behaves("Knight of Doom",
                new RunBehaviors(
                    Chasing.Instance(15, 10, 2, null),
                    new QueuedBehavior(
                        Cooldown.Instance(250, SimpleAttack.Instance(5)),
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Sword of Dark Enchantment"))
                )))
            )
            )
            ;
