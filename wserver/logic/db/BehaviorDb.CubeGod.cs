            ...
            .Init(0x0d59, Behaves("Cube God",
                ...
                IfNot.Instance(
                    ...
                    Rand.Instance(
                     ...
                     Tuple.Create(0.01, (ILoot)new ItemLoot("Cube Generator")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Large Smiley Cloth")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Small Smiley Cloth")),
                            Tuple.Create(0.06, (ILoot)new ItemLoot("Large Blue Striped Cloth")),
                            Tuple.Create(0.06, (ILoot)new ItemLoot("Small Blue Striped Cloth")),
