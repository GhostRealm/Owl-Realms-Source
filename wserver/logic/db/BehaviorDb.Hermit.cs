            ...
            .Init(0x0d61, Behaves("Hermit God",
                new RunBehaviors(
                    If.Instance(IsEntityPresent.Instance(20, null),
                        OrderAllEntity.Instance(50, 0x0d64, Circling.Instance(8, 20, 3, 0x0d61))),
                    If.Instance(IsEntityPresent.Instance(9, null),
                        OrderAllEntity.Instance(50, 0x0d64, Chasing.Instance(4, 2, 0, null))),
                    ...
                    IfEqual.Instance(-1, 4,
                        new RunBehaviors(
                            ...
                            new QueuedBehavior(
                                ...
                                OrderAllEntity.Instance(100, 0x0d63, new SetKey(-1, 0)),
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(360, new LootDef(0, 2, 0, 3,
                        Tuple.Create(0.005, (ILoot) new ItemLoot("Helm of the Juggernaut")),
                        Tuple.Create(0.5, (ILoot) new ItemLoot("Potion of Vitality")),
                        Tuple.Create(0.5, (ILoot) new ItemLoot("Potion of Dexterity"))
                        ))),
            ...
            .Init(0x0d63, Behaves("Whirlpool",
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-2, 0,
                        new QueuedBehavior(
                            Cooldown.Instance(700, SimpleAttack.Instance(10))
                            ))
                    )
                ))
            .Init(0x0d62, Behaves("Hermit Minion",
                IfNot.Instance(
                    Chasing.Instance(6, 4, 2, null),
