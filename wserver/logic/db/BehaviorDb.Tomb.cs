            ...
            .Init(0x0d28, Behaves("Tomb Defender",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 5, 0, 8,
                        ...
                        Tuple.Create(0.009, (ILoot) new ItemLoot("Tome of Holy Protection")),
                        Tuple.Create(0.05, (ILoot) new ItemLoot("Ring of the Pyramid")),
                        Tuple.Create(0.01, (ILoot)new ItemLoot("Ring of the Blood Harvest")),
                        Tuple.Create(0.001, (ILoot)new ItemLoot("Mithril Sword")),
                        Tuple.Create(0.05, (ILoot)new ItemLoot("Staff of Dripping Blood")),
                        Tuple.Create(0.05, (ILoot)new ItemLoot("Sword of Demon Horns")),
                        Tuple.Create(0.03, (ILoot)new ItemLoot("Bes Generator")),
            ...
            .Init(0x0d26, Behaves("Nut",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 2, 0, 2,
                        ...
                        Tuple.Create(0.009, (ILoot)new ItemLoot("Nut Generator")),
                        Tuple.Create(0.05, (ILoot)new ItemLoot("Dagger of Broken Bones")),
                        Tuple.Create(0.05, (ILoot)new ItemLoot("Spell of Deep Depression")),
                        Tuple.Create(0.03, (ILoot)new ItemLoot("Staff of Endless Energy")),
                        Tuple.Create(0.5, (ILoot)new ItemLoot("Large Egyptian Cloth")),
                        Tuple.Create(0.5, (ILoot)new ItemLoot("Small Egyptian Cloth"))
                        )))
                ))
            ...
            .Init(0x0d27, Behaves("Geb",
                ...
                loot: new LootBehavior(LootDef.Empty, //Class for loot.
                    Tuple.Create(100, new LootDef(0, 2, 0, 2,
                        ...
                        Tuple.Create(0.01, (ILoot)new ItemLoot("Ring of the Blood Harvest")),
                        Tuple.Create(0.03, (ILoot)new ItemLoot("Geb Generator")),
                        Tuple.Create(0.01, (ILoot)new ItemLoot("Sphinx Leather Armor")),
                        Tuple.Create(0.01, (ILoot)new ItemLoot("Armor of the Pyramid")),
                        Tuple.Create(0.01, (ILoot)new ItemLoot("Robe of the Nile")),
            ...
            .Init(0x0d29, Behaves("Active Sarcophagus",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 3, 0, 8,
                        ...
                        Tuple.Create(0.05, (ILoot)new ItemLoot("Elder Tomb Key")),
