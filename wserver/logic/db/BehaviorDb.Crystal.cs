            ...
            Flashing.Instance(150, 0x0000FF0C),*/
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 8, 0, 8,
                        ...
                        Tuple.Create(0.06, (ILoot)new ItemLoot("Large Teal Crystal Cloth")),
                        Tuple.Create(0.06, (ILoot)new ItemLoot("Small Teal Crystal Cloth")),
                        Tuple.Create(0.06, (ILoot)new ItemLoot("Large White Diamond Cloth")),
                        Tuple.Create(0.06, (ILoot)new ItemLoot("Small White Diamond Cloth")),
