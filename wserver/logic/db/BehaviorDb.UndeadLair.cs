                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(800, new LootDef(0, 5, 1, 2,
                        Tuple.Create(0.001, (ILoot) new ItemLoot("Doom Bow")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Kunai")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Glaive")),
                            Tuple.Create(0.06, (ILoot)new ItemLoot("Large Cloud Cloth")),
                            Tuple.Create(0.06, (ILoot)new ItemLoot("Small Cloud Cloth")),
                            Tuple.Create(0.04, (ILoot)new ItemLoot("Feather")),
                            Tuple.Create(0.04, (ILoot)new ItemLoot("Shattered Prism")),
                            Tuple.Create(0.04, (ILoot)new ItemLoot("Trapped Soul")),
                            Tuple.Create(0.04, (ILoot)new ItemLoot("Purified Doom Saliva")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Septavius Generator")),
    ...
    //            }
            ...
            .Init(0x0da0, Behaves("Lair Brown Bat",
                ...
                loot: new LootBehavior(
                    new LootDef(0, 1, 0, 8,
                        Tuple.Create(0.1, (ILoot) PotionLoot.Instance),
                        Tuple.Create(0.005, (ILoot)new ItemLoot("Batman's Blade"))
                        ))
                ))
