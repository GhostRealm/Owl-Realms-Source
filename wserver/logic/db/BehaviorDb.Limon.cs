            ...
            .Init(0x0d06, Behaves("Limon the Sprite God",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 1, 0, 1,
                        ...
                        Tuple.Create(0.001, (ILoot) new ItemLoot("Cloak of the Planewalker")),
                        Tuple.Create(0.005, (ILoot) new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Limon Generator")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Large Rainbow Cloth")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Small Rainbow Cloth")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Large Purple Pinstripe Cloth")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Small Purple Pinstripe Cloth")),
