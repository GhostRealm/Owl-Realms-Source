            ...
            .Init(0x090a, Behaves("Archdemon Malphas",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(2, 5, 3, 8,
                     ...
                     Tuple.Create(0.1, (ILoot)new ItemLoot("Prism of Inception")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Cloak of the Joker")),
                            Tuple.Create(0.2, (ILoot)new ItemLoot("Cloak of Dimensions")),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Cloak of the Phantom")),
                            Tuple.Create(0.4, (ILoot)new ItemLoot("Cloak of Forgotten Souls")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Wand of Evil Power")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Malphas Generator")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Raw Power")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Fire Gem")),
                            Tuple.Create(0.06, (ILoot)new ItemLoot("Large Demonic Cloth")),
                            Tuple.Create(0.06, (ILoot)new ItemLoot("Small Demonic Cloth")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Shattered Skull")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Demon Blood")),
