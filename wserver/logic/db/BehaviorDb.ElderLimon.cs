...
namespace wServer.logic
{
    ...
    {
        private static _ ElderSpriteworld = Behav()
            .Init(0x5d06, Behaves("Elder Limon the Sprite God",
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 4,
                        new RunBehaviors(
                            new QueuedBehavior(
                                TossEnemy.Instance(315*(float) Math.PI/180, 9, 0x5d08),
                                TossEnemy.Instance(45*(float) Math.PI/180, 9, 0x5d07),
                                TossEnemy.Instance(135*(float) Math.PI/180, 9, 0x5d09),
                                TossEnemy.Instance(225*(float) Math.PI/180, 9, 0x5d0a),
                                TossEnemy.Instance(315*(float) Math.PI/180, 14, 0x5d08),
                                TossEnemy.Instance(45*(float) Math.PI/180, 14, 0x5d07),
                                TossEnemy.Instance(135*(float) Math.PI/180, 14, 0x5d09),
                                TossEnemy.Instance(225*(float) Math.PI/180, 14, 0x5d0a),
                                new SetKey(-1, 5)
                                ))),
                    ...
                    IfEqual.Instance(-1, 6,
                        new RunBehaviors(
                            ...
                            Flashing.Instance(500, 0xff00ff00),
                            new QueuedBehavior(
                                SpawnMinionImmediate.Instance(0x5d01, 1, 1, 2),
                                SpawnMinionImmediate.Instance(0x5d02, 1, 1, 2),
                ...
                {
                    new DeathPortal(0x6829, 100, -1)
                },
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 1, 0, 1,
                        Tuple.Create(0.005, (ILoot) new ItemLoot("Staff of Extreme Prejudice")),
                        Tuple.Create(0.004, (ILoot)new ItemLoot("Staff of Tainted Light")),
                        Tuple.Create(0.005, (ILoot) new ItemLoot("Wine Cellar Incantation")),
                        Tuple.Create(0.005, (ILoot)new ItemLoot("Star Power")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Large Rainbow Cloth")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Small Rainbow Cloth")),
                    ...
                    Tuple.Create(100, new LootDef(1, 1, 1, 2,
                        Tuple.Create(0.8, (ILoot)new ItemLoot("Potion of Max Dexterity")),
                        Tuple.Create(0.05, (ILoot)new ItemLoot("Potion of Max Defense"))
                        )))))
            .Init(0x5d07, Behaves("Elder Limon Element 1",
                new RunBehaviors(
                    If.Instance(IsEntityNotPresent.Instance(30, 0x5d06), Despawn.Instance),
                    SetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                    Once.Instance(new SetKey(-1, 1)),
                    IfEqual.Instance(-1, 1,
                        new RunBehaviors(
            ...
            .Init(0x5d08, Behaves("Elder Limon Element 2",
                new RunBehaviors(
                    If.Instance(IsEntityNotPresent.Instance(30, 0x5d06), Despawn.Instance),
                    SetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                    Once.Instance(new SetKey(-1, 1)),
            ...
            .Init(0x5d09, Behaves("Elder Limon Element 3",
                new RunBehaviors(
                    If.Instance(IsEntityNotPresent.Instance(30, 0x5d06), Despawn.Instance),
                    SetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                    Once.Instance(new SetKey(-1, 1)),
            ...
            .Init(0x5d0a, Behaves("Elder Limon Element 4",
                new RunBehaviors(
                    If.Instance(IsEntityNotPresent.Instance(30, 0x5d06), Despawn.Instance),
                    SetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                    Once.Instance(new SetKey(-1, 1)),
            ...
            .Init(0x5d00, Behaves("Elder Native Fire Sprite",
            ...
            .Init(0x5d01, Behaves("Elder Native Ice Sprite",
                SimpleWandering.Instance(15),
            ...
            .Init(0x5d02, Behaves("Elder Native Magic Sprite",
                SimpleWandering.Instance(15),
            ...
            .Init(0x5d03, Behaves("Elder Native Nature Sprite",
                SimpleWandering.Instance(15),
            ...
            .Init(0x5d04, Behaves("Elder Native Darkness Sprite",
                SimpleWandering.Instance(15),
                Cooldown.Instance(1000, MultiAttack.Instance(10, 7*(float) Math.PI/180, 5)),
                loot: new LootBehavior(
                    new LootDef(0, 2, 0, 8,
            ...
            .Init(0x5d05, Behaves("Elder Native Sprite God",
