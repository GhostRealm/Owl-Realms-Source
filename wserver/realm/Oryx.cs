    ...
    internal class Oryx
    {
        ...
        public bool CheckFinalQuests()
        {
            if (CountEnemies(
                ...
                "Phoenix Lord", "Phoenix Egg", "Phoenix Reborn",
        ...
        public void CloseRealm()
        {
            ...
            {
                //var wcWorld = RealmManager.AddWorld(new WineCellarMap());
//                var wcWorld = RealmManager.AddWorld(new TurkeyMap());
                var wcWorld = RealmManager.AddWorld(new OryxsCastle());
                foreach (var i in world.Players.Values)
                {
