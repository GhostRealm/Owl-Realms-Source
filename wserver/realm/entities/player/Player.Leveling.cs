    ...
    public partial class Player
    {
        private static readonly Dictionary<string, Tuple<int, int, int>> QuestDat =
            new Dictionary<string, Tuple<int, int, int>> //Priority, Min, Max
            {
                ...
                {"Elder Dreadstump the Pirate King", Tuple.Create(20, 1, 20)},
                {"Elder Arachna the Spider Queen", Tuple.Create(20, 1, 20)},
                {"Elder Stheno the Snake Queen", Tuple.Create(20, 1, 20)},
                {"Elder Limon the Sprite God", Tuple.Create(20, 1, 20)},
                {"Elder Septavius the Ghost God", Tuple.Create(20, 1, 20)},
                {"Elder Archdemon Malphas", Tuple.Create(20, 1, 20)},
            };
