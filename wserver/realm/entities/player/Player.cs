...
//            if (psr.Account.Name == "Lucifer" || psr.Account.Name == "Luciferus" || psr.Account.Name == "HaseoAura")
                    ...
                    else
                    {
                        switch (entity.ObjectType) //handling default case for not found. Add more as implemented
                        {
                            ...
                            case 0x071b:
                                ...
                                break;
                            case 0x0741:
                                world = RealmManager.AddWorld(new Davy());
                                break;
                            case 0x071a:
                            ...
                            case 0x072c:
                                ...
                                break;
                            case 0x1907:
                                world = RealmManager.AddWorld(new Dragonlord()); 
                                break;
                            case 0x0717:
                                world = RealmManager.AddWorld(new PirateCave()); 
                                break;
                            case 0x6717:
                                world = RealmManager.AddWorld(new ElderPirateCave()); 
                                break;
                            case 0x6827:
                                world = RealmManager.AddWorld(new ElderSnakePit());
                                break;
                            case 0x6838:
                                world = RealmManager.AddWorld(new ElderSpriteWorld());
                                break;
                            case 0x6829:
                                world = RealmManager.AddWorld(new ElderUndeadL());
                                break;
                            case 0x6837:
                                world = RealmManager.AddWorld(new ElderAbyss());
                                break;
                            case 0x6817:
                                world = RealmManager.AddWorld(new ElderSpiderDen());
                                break;
                            case 0x6939:
                                world = RealmManager.AddWorld(new ElderDraconis());
                                break;
                            case 0x6719:
                                world = RealmManager.AddWorld(new ElderTombMap());
                                break;
                            case 0x0739:
                                world = RealmManager.AddWorld(new Manor()); 
                                break;
                            case 0x2928:
                                world = RealmManager.AddWorld(new Dcellar()); 
                                break;
                            case 0x2909:
                                world = RealmManager.AddWorld(new DoomCrystal()); 
                                break;
                            case 0x0733:
                                world = RealmManager.AddWorld(new Jungle()); 
                                break;
                            case 0x5d7b:
                                world = RealmManager.AddWorld(new OryxsCastle());
                                break;
                            case 0x6d7b:
                                world = RealmManager.AddWorld(new OryxsChamber());
                                break;
                            case 0x6373:
                                world = RealmManager.AddWorld(new ChristmasOryxsChamber());
                                break;
                                /*
                            case 0x5050:
                            ...
                            case 0x1905:
                            {
                                psr.SendPacket(new TextBoxPacket
                                {
                                    Button1 = "Enter",
                                    Button2 = "Cancel",
                                    Message = "Have sex with the price of 50000 fame?",
                            ...
                            case 0x0718:
                                ...
                                break;
                            case 0x0719:
                                world = RealmManager.AddWorld(new SpiderDen());
                                break;
                            case 0x0890:
                            ...
                            case 0x0704:
                                ...
                                break;
                            case 0x753E:
                                world = RealmManager.AddWorld(new Draconis());
                                break;
                            case 0x7002:
                            ...
                            case 0x701c:
                            {
                                psr.SendPacket(new TextBoxPacket
                                {
                                    Button1 = "Enter",
                                    Button2 = "Cancel",
                                    Message = "Join sheep herding at the price of 50 fame?",
                                    Title = "Sheep Herding",
                                    Type = "SheepHerding"
                                });
                            }
                            ...
                            case 0x7024:
                            {
                                psr.SendPacket(new TextBoxPacket
                                {
                                    Button1 = "Yes",
                                    Button2 = "Cancel",
                                    Message = "Join zombies at the price of 10 fame?",
                                    Title = "Zombies",
                                    Type = "Zombies"
                                });
                            }
        ...
        public void GivePet(short petId)
        {
            ...
            {
                Console.WriteLine("Error at line 1191 of Player.cs");
            } { }
...
//                case "Ghost":
                    ...
                    Owner.BroadcastPacket(new TextPacket
                    {
                        ...
                        Stars = -1,
                        Name = "",
                        Text = Name + " failed at Level " + Level + ", with " + Fame + " Fame" + ", escaped from " + killer
