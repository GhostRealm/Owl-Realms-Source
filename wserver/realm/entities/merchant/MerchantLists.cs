...
{0x101d, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //Dark Orange
{0x1063, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //Orange
{0x1070, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //Purple
{0x108c, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //St Patrick's Green
...
{0x111d, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //Dark Orange
{0x1163, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //Orange
{0x1170, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //Purple
{0x118c, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //St Patrick's Green
        ...
        public static int[] store7List = { 0xc81, 0x2fbc, 0x1906, 0x2908, 0x701, 0x705, 0x706, 0x70a, 0x70b, 0x710, 0x71f, 0x722, 0xc11, 0xc19, 0xc23, 0xc2e, 0xc3d, 0x2927, 0xc2f, 0xc19 }; // Nexus Keys

        public static int[] store8List =
        {
            0x1007, 0x1009, 0x100b, 0x1010, 0x1012, 0x1015, 0x101f, 0x1002, 0x1004, 0x1033, 0x102f, 0x1079, 0x108c, 0x1030, 0x1063, 0x101d, 0x1070
        }; // Large Dyes

        public static int[] store9List =
        {
            0x1107, 0x1109, 0x110b, 0x1110, 0x1112, 0x1115, 0x111f, 0x1102, 0x1104, 0x1133, 0x112f, 0x1179, 0x118c, 0x1130, 0x1163, 0x111d, 0x1170
        }; // Small Dyes
        ...
        public static void AddCustomShops()
        {
            ...
            {
                prices.Add(i.Key, new Tuple<int, CurrencyType>(i.Value, CurrencyType.Gold));
            }
